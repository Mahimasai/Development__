...
- Fantom message problem (Ghost message) in message

- To solve this , a team created react , after updates the problem was solved

## React is a library

Difference in framework and library that framework is like military (fixed and rules ) , library is like cool dude (flexible)
